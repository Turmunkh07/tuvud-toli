    ...
    <AdminPageShell>
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Хэрэв эх сурвалж дунд зөрчил гарсан тохиолдолд энэ хуудсанд жагсаагдана. Аль нь зөв
          болохыг сонгох хүртэл шинэ хувилбарыг толь бичигт нэмээгүй хүлээлгэнд байлгав.
        </p>
      </div>
